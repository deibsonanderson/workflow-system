						...
						<tr>
                            ...
                            <td style="text-align:center">
                            	<div class="btn-group ml-auto">
	                                ...
	                                <button onclick="fcnModalDeleteId(this)" modal="question" id="<?php echo $modulo->getId(); ?>" funcao="excluirCategoriaAtividade" controlador="ControladorCategoriaAtividade" retorno="div_central" mensagem="4" class="deleteId btn btn-sm btn-outline-light"><i class="far fa-trash-alt"></i></button> 
	                            </div> 
                            </td>								
						</tr>	
					<?php
